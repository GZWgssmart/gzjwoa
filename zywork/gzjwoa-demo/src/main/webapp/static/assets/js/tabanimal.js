...
function getCss(a, b) {
    ...
    if (window.getComputedStyle) return parseFloat(getComputedStyle(a, null)[b]); else return parseFloat(a.currentStyle[b])
};
    ...
    var zhufengEffect = {
        zfLinear: function (t, b, c, d) {
            ...
            easeIn: function (t, b, c, d) {
                ...
                if (t < d / 2) return zhufengEffect.zfBounce.easeIn(t * 2, 0, c, d) * .5 + b; else return zhufengEffect.zfBounce.easeOut(t * 2 - d, 0, c, d) * .5 + c * .5 + b
            }
        }
    };
...
;(function () {
    ...
    for (var i = 0; i < c.length; i++) {
        ...
        c.item(i).onmouseover = function () {
            ...
            var w = a.offsetWidth;
            var l = a.offsetLeft;
            animate(b, {left: l, width: w}, 500, 4)
        }
    }
})();
