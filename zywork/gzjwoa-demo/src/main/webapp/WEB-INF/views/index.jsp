...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="<%=path %>/login/out" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2018 <a href="#" target="_blank">赣州市纪委</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
