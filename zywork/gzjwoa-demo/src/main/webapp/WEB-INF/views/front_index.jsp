...
<div class="div-01">
    <div class="nav" id="nav-h">
        <span class="nav-button" id="toggle-ul">打开菜单</span>
        <ul id="toggle-li">
            <li><a href="<%=path%>/" target="_self">首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</a></li>
            <li><a href="javascript:" target="_blank">机 关 简 介</a></li>
            <li><a href="javascript:" target="_blank">部 门 频 道</a></li>
            <li><a href="javascript:" target="_blank">软 件 下 载</a></li>
            <li><a href="<%=path%>/back-index" target="_blank">办 公 登 录</a></li>
            <li><a href="javascript:" target="_blank">案 管 登 录</a></li>
        </ul>
        <div class="cls"></div>
    </div>
</div>
            ...
            <div class="pages" data-scro="list">
                <ul>
                    <li class="item" style="left:0;">
                        <a href="http://www.dijiuzhanzhang.com/" target="_blank"><img src="<%=path%>/static/assets/images/1.png" width="570" height="400"></a>
                        <h3>
                            <a href="http://www.dijiuzhanzhang.com/" target="_blank" style="color:#FFF;text-decoration:none;">
                                【漫话·国家监委ABC③】 中央纪委和国家监委为什么合署办公
                            </a>
                        </h3>
                        <div></div>
                    </li>
                    <li class="item">
                        <a href="http://www.dijiuzhanzhang.com/" target="_blank"><img src="<%=path%>/static/assets/images/2.png" width="570" height="400"></a>
                        <h3><a href="http://www.dijiuzhanzhang.com/" target="_blank" style="color: #FFF; text-decoration:none;">【长漫画】监察委员会，国家机构中的新面孔</a></h3>
                        <div></div>
                    </li>
                    <li class="item">
                        <a href="http://www.dijiuzhanzhang.com/" target="_blank"><img src="<%=path%>/static/assets/images/3.png" width="570" height="400"></a><h3>
                        <a href="http://www.dijiuzhanzhang.com/" target="_blank" style="color: #FFF; text-decoration:none;">中华人民共和国监察法</a></h3>
                        <div></div>
                    </li>
                </ul>
            </div>
        ...
        for(var i = 0; i<myLi.length;i++){
            ...
            myLi[i].onclick = function(){
                for(var j = 0; j < myLi.length; j++){
                    ...
                    myDiv[j].className = "hidee";
                }
                this.className = "on";
                myDiv[this.index].className = "shows";
            }
        }
    };
