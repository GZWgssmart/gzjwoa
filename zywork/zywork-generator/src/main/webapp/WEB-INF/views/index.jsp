            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/setting/jdbc-page" data-index="0">JDBC配置</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path%>/setting/generator-page" data-index="0">Generator配置</a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<%=path%>/single-table/page" data-index="0">单表代码生成</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<%=path%>/join-table/page" data-index="0">关联表代码生成</a>
                        </li>
                    </ul>
